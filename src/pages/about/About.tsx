...
const About = () => {
  ...
  return (
    <PageTransition>
    <div className="flex flex-col items-center py-10 px-4 md:px-8 lg:px-32">
      <h1 className="text-3xl font-bold text-center mb-6 animate-fade-in">
        {t("about.title")}
      </h1>

      <div className="flex flex-col lg:flex-row lg:justify-between w-full">
        <div className="lg:w-2/3 mb-10 lg:mb-0 mr-0 md:mr-24 space-y-6">
      ...
      <div className="mt-10 space-y-6 w-full">
        ...
        <p className="text-base w-full max-w-6xl leading-relaxed transition-all duration-300">
      ...
      <div className="mt-10 space-y-6 w-full">
        ...
        <p className="text-base leading-relaxed w-full max-w-6xl transition-all duration-300">
